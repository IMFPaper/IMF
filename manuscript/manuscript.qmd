...
The selection of covariates, including their polynomial transformations[^8], closely follows @lipscy2018 and @barro2005 to ensure comparability with previous findings.

[^8]: Quadratic terms are included for GDP and per capita GDP to capture potential non-linear effects. See [Model Specification] for details.
