...
International Relations theory, particularly realism, has long emphasised that international organisations reflect underlying distributions of power rather than operating as neutral or autonomous actors. As Mearsheimer famously argued, international institutions are “basically a reflection of the distribution of power in the world” [@mearsheimer1994]. The International Monetary Fund (IMF), despite its formal presentation as a rules-based and technocratic institution [@barnett2004; @chwieroth2015; @lutz2019], is no exception [@copelovitch2010a, @stone2011]. Empirical studies have consistently shown that geopolitical considerations play a central role in IMF lending decisions.
...
The literature on Europe's influence in the IMF is rather fragmented and lacks systematic research. Most scholars (such as [@smaghi2004; @thacker1999 ; @miescu2014]) argue that the representatives from Europe are rather scattered, while the United States remains the dominant force. However, there are also scholars (such as [@keating2024; @lutz2014; @copelovitch2010a; @stone2004]) who argue that Europe has significant advantages in leadership, voting power, agenda setting, overseas influence, and promoting its own interests, which enables it to play an indispensable role in the issue of IMF loans.

First, European countries have structural advantages in IMF institutions. As mentioned in the introduction, the IMF's leadership has long been held by Europeans, and this gentleman's agreement between the United States and Europe has always worked in practice [@keating2024]. EU countries hold more than 30% of the voting rights in the IMF, among which Britain, France and Germany hold seats alone [@leech2005a]. Research shows that if European countries unify their seats, it is highly possible that they will have equal veto power compared to the United States [@brandner2009a].

Second, European countries dominate policy design and technical bureaucracy. [@lutz2014]'s research shows that the EU and the European Central Bank promoted the "Washington Consensus"-style austerity policy in the IMF's loans to Central and Eastern European countries (such as Latvia and Romania). This is because France and Germany have high exposure to Eastern European banking risks. Specifically, European countries have formed a consistent position within the IMF through the EURIMF (European Representatives to the IMF) and SCIMF (Sub-committee on the IMF) mechanisms, which makes it easier to put pressure on the IMF to promote policies that are beneficial to European interests (ibid.). Meanwhile, during the European debt crisis, France and Germany pushed for the participation of the IMF in rescue efforts and established a joint mechanism of the IMF, the European Commission and the European Central Bank to deal with the crisis [@veron2016]. European countries were both lenders and borrowers. However, this move has also been criticized for the IMF overly obeying the will of major European powers, and it is believed that the failure of European governments to adopt the IMF's reform suggestions is the core cause of the outbreak of the European debt crisis (ibid.).
