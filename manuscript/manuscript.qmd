...
[^12]: Based on an $F$-test for the null hypothesis that USA=EUP. The associated $p$-values are 0.021 and 0.014, respectively. For loan approval, the difference is nearly significant at the 10% level ($p=0.122$).
