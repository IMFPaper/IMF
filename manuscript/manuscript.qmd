...
In comparison, the literature on European influence is notably smaller. The most visible manifestation of European power within the Fund is the tradition of European leadership: all Managing Directors of the IMF since its inception have been European nationals [@kahler2001]. Scholars have also pointed to Europe-backed lending decisions, such as those during the Eurozone crisis (notably Greece) [@lipscy2018; @hodson2014], and loans to former colonies in Africa [@stone2004]. However, while these studies offer important insights, they tend to remain case-specific or anecdotal. Crucially, they stop short of offering a systematic comparison between American and European influence, leaving open the question of how these two centres of power operate within the IMF.

Yet, much of the quantitative literature has remained US-centric, often using only American alignment as the independent variable of interest [@thacker1999; @oatley2004; @dreher2009]. Others pool European indicators with US ones, often under the umbrella of “Western” influence [@lipscy2018, @barro2005].
