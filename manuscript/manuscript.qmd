...
\color{red}
However, empirical studies suggested that countries with low international reserves, high current account deficits, and low GDP growth are more likely to receive IMF funding assistance [@barro2005; @knight1997], despite such indicators often reflecting a limited capacity to repay.
\color{black}
