...
```{r setup}
need <- c('AER','car','kableExtra','modelsummary','parameters') # list packages needed
...
msummary(regtable, coef_map=coefmap, gof_map=gof_map, stars=T, escape=F, output = "kableExtra") |>
